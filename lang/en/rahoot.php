...
$string['yourresultlast'] = 'Your last try: {$a->correct} of {$a->total} right ({$a->percent}%), try {$a->attempt}. You have played {$a->attempts} time(s).';
$string['resultstoken'] = 'Results token';
$string['resultstoken_desc'] = 'Must match SOLO_RESULTS_TOKEN on the Rahoot server. Leave empty only if that server does not require one. Unlike the quiz list, the results carry each person\'s score, so they are worth closing off.';
$string['tasksyncresults'] = 'Bring Rahoot results into the gradebook';
$string['resetresults'] = 'Delete Rahoot results';
$string['resultsdeleted'] = 'Rahoot results deleted';
$string['privacy:metadata:rahoot_attempts'] = 'The copy of a person\'s Rahoot result that this activity\'s grade is built from.';
$string['privacy:metadata:rahoot_attempts:userid'] = 'The person the result belongs to.';
$string['privacy:metadata:rahoot_attempts:account'] = 'The directory account the quiz was played under.';
$string['privacy:metadata:rahoot_attempts:attempts'] = 'How many times the person played this quiz.';
$string['privacy:metadata:rahoot_attempts:bestpercent'] = 'Share of questions answered correctly in their best try.';
$string['privacy:metadata:rahoot_attempts:besttime'] = 'When their best try finished.';
$string['privacy:metadata:rahoot_attempts:lastpercent'] = 'Share of questions answered correctly in their last try.';
