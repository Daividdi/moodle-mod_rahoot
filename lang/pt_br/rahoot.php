...
$string['rahoot:viewallresults'] = 'Ver todos os resultados do Rahoot';
...
$string['viewallresults'] = 'Ver resultados do Rahoot';
$string['resultsreport'] = 'Resultados do Rahoot';
$string['resultssyncednotice'] = 'Este relatório mostra os resultados sincronizados no Moodle. A tarefa automática roda a cada cinco minutos.';
$string['userfilter'] = 'Usuário';
$string['allusers'] = 'Todos os usuários';
$string['filter'] = 'Filtrar';
$string['refreshresults'] = 'Atualizar resultados do Rahoot';
$string['downloadcsv'] = 'Baixar CSV';
$string['account'] = 'Conta';
$string['attempts'] = 'Tentativas';
$string['bestresult'] = 'Melhor resultado';
$string['besttime'] = 'Melhor conclusão';
$string['lastresult'] = 'Último resultado';
$string['lasttime'] = 'Última conclusão';
$string['resultsfound'] = '{$a} resultado(s)';
$string['noresults'] = 'Nenhum resultado sincronizado foi encontrado para esta atividade.';
$string['resultsrefreshed'] = '{$a} resultado(s) atualizado(s) do Rahoot.';
$string['resultsrefreshfailed'] = 'Não foi possível atualizar os resultados do Rahoot agora. O relatório mostra os últimos dados armazenados no Moodle.';
$string['backtoactivity'] = 'Voltar para a atividade Rahoot';
...
$string['yourresultlast'] = 'Sua última tentativa: {$a->correct} de {$a->total} certas ({$a->percent}%), tentativa {$a->attempt}. Você jogou {$a->attempts} vez(es).';
$string['resultstoken'] = 'Token dos resultados';
$string['resultstoken_desc'] = 'Precisa ser igual ao SOLO_RESULTS_TOKEN no servidor Rahoot. Deixe vazio só se aquele lado também não exigir. Diferente da lista de quizzes, os resultados trazem a nota de cada pessoa, então vale fechar.';
$string['tasksyncresults'] = 'Trazer os resultados do Rahoot para o boletim';
$string['resetresults'] = 'Apagar os resultados do Rahoot';
$string['resultsdeleted'] = 'Resultados do Rahoot apagados';
$string['privacy:metadata:rahoot_attempts'] = 'A cópia do resultado da pessoa no Rahoot, da qual a nota desta atividade é calculada.';
$string['privacy:metadata:rahoot_attempts:userid'] = 'A pessoa a quem o resultado pertence.';
$string['privacy:metadata:rahoot_attempts:account'] = 'A conta de rede com que o quiz foi jogado.';
$string['privacy:metadata:rahoot_attempts:attempts'] = 'Quantas vezes a pessoa jogou este quiz.';
$string['privacy:metadata:rahoot_attempts:bestpercent'] = 'Proporção de acertos na melhor tentativa.';
$string['privacy:metadata:rahoot_attempts:besttime'] = 'Quando a melhor tentativa terminou.';
$string['privacy:metadata:rahoot_attempts:lastpercent'] = 'Proporção de acertos na última tentativa.';
